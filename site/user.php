                ...
                <div class="card-body">
                    ...
                    <form method="post" action="user.php?cv=atualizar">
                        ...
                        <div class="form-group">
                            <div class="form-label-group ">
                                <label for="telefone">Telefone</label>
                                <input value="<?= $dados['telefone'] ?>" name='telefone' type="text" id="telefone" class="form-control" placeholder="Telefone" required="required" onkeypress="mascara(this, '## ########')" pattern="[0-9 -]+" maxlength="12" minlength="10">

                            </div>
                            <div class="form-label-group ">
                                <label for="cpf">CPF</label>
                                <input readonly="" value="<?= $dados['cpf'] ?>" name='cpf' type="text" id="cpf" class="form-control" placeholder="CPF" required="required">
                        ...
                        <div class="form-group">
                            <div class="form-label-group ">
                                <label for="senha">Senha</label>
                                <input value="" name='senha' type="password" id="senha" class="form-control" placeholder="Senha" required="required" minlength="4">

                            </div>
                            <div class="form-label-group ">
                                <label for="novasenha">Nova Senha (Opcional)</label>
                                <input name='novasenha' type="password" id="novasenha" class="form-control" placeholder="Nova Senha" minlength="4">
